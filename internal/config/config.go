...
func LoadFrom(lookup func(string) (string, bool)) (*Config, error) {
	...
	cfg := &Config{
		...
		AppEnv:            string(profile), JWTSecret: get("JWT_SECRET", ""), JWTIssuer: get("JWT_ISSUER", "kitchen-sink-local"), JWTAudience: get("JWT_AUDIENCE", "kitchen-sink"), AccessTokenTTL: accessTTL, RefreshTokenTTL: refreshTTL,
